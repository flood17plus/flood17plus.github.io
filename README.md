# Купальская ночь — поздравление с Днём рождения

Статический сайт-поздравление в стиле тёмной славянской мифологии (Купальская ночь в ночном лесу). Чистый HTML + CSS + vanilla JS, без зависимостей и сборки.
